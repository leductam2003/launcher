...
export class Repeat extends QueueBase {
    ...
    async addNextRepeatableJob(name, data, opts, skipCheckExists) {
        ...
        if (nextMillis) {
            ...
            const repeatJobKey = await this.scripts.addRepeatableJob((_b = opts.repeat.key) !== null && _b !== void 0 ? _b : this.hash(qualifiedName), nextMillis, {
                name,
    ...
    async removeRepeatable(name, repeat, jobId) {
        var _a;
        const qualifiedName = getRepeatCocatOptions(name, Object.assign(Object.assign({}, repeat), { jobId }));
        const repeatJobKey = (_a = repeat.key) !== null && _a !== void 0 ? _a : this.hash(qualifiedName);
        ...
        return this.scripts.removeRepeatable(legacyRepeatJobId, qualifiedName, repeatJobKey);
    }
...
function getRepeatCocatOptions(name, repeat) {
