...
export class Scripts {
    ...
    removeRepeatableArgs(legacyRepeatJobId, qualifiedName, repeatJobKey) {
        const queueKeys = this.queue.keys;
    ...
    async removeRepeatable(legacyRepeatJobId, qualifiedName, repeatJobKey) {
        const client = await this.queue.client;
        const args = this.removeRepeatableArgs(legacyRepeatJobId, qualifiedName, repeatJobKey);
