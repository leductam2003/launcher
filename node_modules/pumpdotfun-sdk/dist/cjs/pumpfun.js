...
class PumpFunSDK {
    ...
    async createAndBuyAndSnipe(creator, mint, createTokenMetadata, buyAmountSol, snipePrivateKeys, snipeAmounts, slippageBasisPoints = 500n, priorityFees, tipFee = 0, commitment = util_1.DEFAULT_COMMITMENT, finality = util_1.DEFAULT_FINALITY) {
        ...
        for (let _ = 0; _ < snipePrivateKeys.length; _++) {
            ...
            const buyAmountWithSlippage = (0, util_1.calculateWithSlippageBuy)(amount, slippageBasisPoints);
    ...
    async sell(seller, mint, sellTokenAmount, slippageBasisPoints = 500n, priorityFees, tipFee = 0, commitment = util_1.DEFAULT_COMMITMENT, finality = util_1.DEFAULT_FINALITY) {
        ...
        let sellResults = await (0, util_1.sendTx)(this.connection, sellTx, seller.publicKey, [seller], priorityFees, tipFee, commitment, finality);
        return sellResults;
    }
