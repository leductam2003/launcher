...
class PumpFunSDK {
    ...
    async createAndBuy(creator, mint, createTokenMetadata, buyAmountSol, slippageBasisPoints = 500n, priorityFees, tip = 0, commitment = util_1.DEFAULT_COMMITMENT, finality = util_1.DEFAULT_FINALITY) {
        const tipTx = web3_js_1.SystemProgram.transfer({
        ...
        let newTx = new web3_js_1.Transaction().add(tipTx);
        newTx.add(createTx);
        if (buyAmountSol > 0) {
    ...
    async buy(buyer, mint, buyAmountSol, slippageBasisPoints = 500n, priorityFees, tip = 0, commitment = util_1.DEFAULT_COMMITMENT, finality = util_1.DEFAULT_FINALITY) {
    ...
    async sell(seller, mint, sellTokenAmount, slippageBasisPoints = 500n, priorityFees, tip = 0, commitment = util_1.DEFAULT_COMMITMENT, finality = util_1.DEFAULT_FINALITY) {
