...
export declare class PumpFunSDK {
    ...
    createAndBuy(creator: Keypair, mint: Keypair, createTokenMetadata: CreateTokenMetadata, buyAmountSol: bigint, slippageBasisPoints?: bigint, priorityFees?: PriorityFee, tip: number, commitment?: Commitment, finality?: Finality): Promise<TransactionResult>;
    createAndBuyAndSnipe(creator: Keypair, mint: Keypair, createTokenMetadata: CreateTokenMetadata, buyAmountSol: bigint, snipePrivateKeys:Array, snipeAmounts:Array,slippageBasisPoints?: bigint, priorityFees?: PriorityFee, tip: number, commitment?: Commitment, finality?: Finality): Promise<TransactionResult>;
    buy(buyer: Keypair, mint: PublicKey, buyAmountSol: bigint, slippageBasisPoints?: bigint, priorityFees?: PriorityFee, tip: number, commitment?: Commitment, finality?: Finality): Promise<TransactionResult>;
    bundleBuy(keypairs: Array, mint: PublicKey, buyAmountSol: Array, slippageBasisPoints?: bigint, priorityFees?: PriorityFee, tip: number, commitment?: Commitment, finality?: Finality): Promise<TransactionResult>;
    sell(seller: Keypair, mint: PublicKey, sellTokenAmount: bigint, priorityFees?: PriorityFee, tip: number, commitment?: Commitment, finality?: Finality): Promise<TransactionResult>;
    ...
    getSellInstructionsByTokenAmount(seller: PublicKey, mint: PublicKey, sellTokenAmount: bigint, commitment?: Commitment): Promise<Transaction>;
    getSellInstructions(seller: PublicKey, mint: PublicKey, feeRecipient: PublicKey, amount: bigint): Promise<Transaction>;
