...
function senbdTxUsingBloxroute({ serializedTx}) {
    return __awaiter(this, void 0, void 0, function* () {
        let encodedTx = bs58_1.default.encode(serializedTx);
        let payload = {
            jsonrpc: '2.0',
        ...
        let res = yield (0, node_fetch_1.default)(`https://ny.solana.dex.blxrbdn.com/api/v2/submit`, {
            method: 'POST',
            body: JSON.stringify(payload),
            headers: { 'Authorization': 'OWRiNTA2MTctYmQ1MS00YWJhLWE1ZWQtMzBiNWVmODRmMmQxOmFhMDZmOWYzMmFlNDViNTE1ZTM3YTEzOWNjMTI0ZDg3', 'Content-Type' : "application/json" }
        });
        let json = yield res.json();
        if (json.error) {
            throw new Error(json.error.message);
...
exports.senbdTxUsingBloxroute = senbdTxUsingBloxroute;
/**
